...
export const COURSES: ReadonlyArray<Course> = [
  ...
  },
  {
    ...
    features: ['Hands-on AWS console labs','Real CI/CD pipeline projects','Expert trainers','Placement assistance','Flexible batches','AWS certification guidance'],
    icon: 'Cloud',
    color: 'bg-orange-500',
  },
  {
    ...
    features: ['Hands-on Azure portal labs','Real pipeline projects','Expert trainers','Placement assistance','Flexible batches','AZ-400 exam guidance'],
    icon: 'Cloud',
    color: 'bg-blue-500',
  },
  {
    ...
    features: ['Hands-on hacking labs','Real penetration testing projects','Expert trainers','Placement assistance','Flexible batches','CEH certification guidance'],
    icon: 'Settings',
    color: 'bg-red-600',
  },
  {
  ...
  },
  {
    ...
    features: ['Figma & Adobe XD hands-on labs','Real design projects','Expert trainers','Placement assistance','Flexible batches','Portfolio development support'],
    icon: 'Code',
    color: 'bg-pink-600',
  },
  {
  ...
  },
  {
    ...
    features: ['Hands-on GCP console labs','Real cloud projects','Expert trainers','Placement assistance','Flexible batches','ACE certification guidance'],
    icon: 'Cloud',
    color: 'bg-blue-500',
  },
  {
