...
export default function LandingPageTemplate({ course, branches, pageSlug: _pageSlug }: Props) {
  ...
  return (
    <div>
      ...
      {/* Sticky mobile CTA bar — md:hidden so desktop never sees it */}
      <div className="fixed bottom-0 left-0 right-0 z-50 md:hidden">
        {/* Safe area padding for iOS home indicator */}
        <div
          className="bg-[#0d1b2e] border-t-2 border-orange-500 shadow-[0_-4px_24px_rgba(0,0,0,0.5)]"
        ...
        >
          <div className="grid grid-cols-3">
            ...
            <a
              href={`tel:${phone1}`}
              className="flex flex-col items-center justify-center gap-1 py-3 text-slate-300 hover:bg-white/5 active:bg-white/10 transition-colors border-r border-slate-700"
            >
            ...
            {/* WhatsApp button — opens the chat widget */}
            <button
              type="button"
              onClick={() => window.dispatchEvent(new Event('coss:open-whatsapp'))}
              className="flex flex-col items-center justify-center gap-1 py-3 w-full text-slate-300 hover:bg-white/5 active:bg-white/10 transition-colors border-r border-slate-700"
            ...
            {/* Book Demo button — orange, most prominent */}
            <a
              href="/free-demo-class"
              className="flex flex-col items-center justify-center gap-1 py-3 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 transition-colors"
            >
              <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/>
              </svg>
              <span className="text-[10px] font-bold text-white tracking-wide">Book Demo</span>
            </a>
