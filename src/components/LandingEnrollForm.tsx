...
export default function LandingEnrollForm({ courseTitle, duration, level, phone1 }: Props) {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-[0_20px_60px_rgba(0,0,0,0.35)] border border-slate-100 dark:border-slate-700 relative overflow-hidden">
      ...
      <form onSubmit={handleSubmit} noValidate>
        <div className="flex items-center gap-3 border-2 border-slate-200 dark:border-slate-600 rounded-xl px-4 py-3.5 mb-3 bg-white dark:bg-slate-800 focus-within:border-orange-400 dark:focus-within:border-orange-500 transition-colors duration-200">
          ...
          <input
            ...
            className="flex-1 bg-transparent outline-none text-slate-800 dark:text-slate-100 text-sm placeholder:text-slate-400 font-medium"
          />
        </div>
        <div className="flex items-center gap-3 border-2 border-slate-200 dark:border-slate-600 rounded-xl px-4 py-3.5 mb-3 bg-white dark:bg-slate-800 focus-within:border-orange-400 dark:focus-within:border-orange-500 transition-colors duration-200">
          <svg className="w-5 h-5 text-orange-500 flex-shrink-0" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
        ...
        <div className="grid grid-cols-2 gap-2.5 mb-3">
          <div className="flex items-center gap-2 border-2 border-slate-200 dark:border-slate-600 rounded-xl px-3 py-3.5 bg-white dark:bg-slate-800 focus-within:border-orange-400 transition-colors duration-200">
            ...
            <select
              ...
              disabled={isSubmitting}
              className="flex-1 bg-transparent outline-none text-slate-500 dark:text-slate-400 text-xs font-medium cursor-pointer"
            >
