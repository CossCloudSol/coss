...
export const NAV_GROUPS: ReadonlyArray<NavGroup> = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Social posts',    icon: Send,          href: '/admin/social-posts',   desc: 'Scheduled Buffer posts' },
    ],
  },
  {
    id: 'site',
...
export function getActiveGroup(pathname: string): string {
  ...
  if (['/admin/categories', '/admin/courses', '/admin/blog', '/admin/jobs', '/admin/batches', '/admin/trainers', '/admin/testimonials', '/admin/hiring-partners', '/admin/social-posts'].some(p => pathname.startsWith(p))) return 'content';
