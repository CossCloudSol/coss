...
const STATIC_PAGE_DATA: ReadonlyArray<{
...
}> = [
  {
    ...
    ogDescription: 'Join 5000+ students who launched IT careers at COSS. AI, Cloud, DevOps, Data Science & 30+ courses with 100% placement assistance in Hyderabad.',
    ogImage: OG_IMAGE,
    canonicalUrl: `${S}/`,
  ...
  },
  {
    pageSlug: 'courses',
    pageTitle: 'Courses',
    metaTitle: 'IT Courses in Hyderabad — AI, Cloud, DevOps & More | COSS',
    ...
    ogTitle: '30+ IT Courses in Hyderabad with Placement | COSS',
  ...
  },
  {
    ...
    metaDescription: 'Learn about COSS Cloud Solutions — a leading IT training institute in Hyderabad since 2014. 5000+ students placed, expert trainers, Dilsukhnagar & Ameerpet branches.',
    ...
    ogDescription: 'Leading IT training institute in Hyderabad since 2014. 5000+ students placed, 2 centres, 30+ courses, expert trainers with 10+ years of industry experience.',
    ogImage: OG_IMAGE,
    canonicalUrl: `${S}/about-us/`,
    schemaMarkup: JSON.stringify({ '@context': 'https://schema.org', '@type': 'AboutPage', url: `${S}/about-us/`, name: 'About COSS Cloud Solutions', breadcrumb: bc({ name: 'Home', item: `${S}/` }, { name: 'About Us', item: `${S}/about-us/` }), mainEntity: { '@id': ORG }, foundingDate: '2014' }),
  },
  {
    pageSlug: 'why-us',
    pageTitle: 'Why Choose Us',
    metaTitle: 'Why Choose COSS Cloud Solutions for IT Training in Hyderabad',
    metaDescription: 'Discover why 5000+ students chose COSS — industry expert trainers, 100% placement support, flexible batches, small batch sizes & affordable fees in Hyderabad.',
    focusKeyword: 'why choose COSS Cloud Solutions',
    keywords: 'best IT training institute Hyderabad, why choose COSS, 100% placement IT training Hyderabad, expert IT trainers Hyderabad, affordable IT courses Hyderabad',
    ogTitle: 'Why Choose COSS Cloud Solutions for IT Training in Hyderabad',
    ogDescription: 'Expert trainers, 100% placement support, flexible batches, affordable fees & globally recognised certifications. Discover why 5000+ students chose COSS.',
    ogImage: OG_IMAGE,
    canonicalUrl: `${S}/why-us/`,
    schemaMarkup: JSON.stringify({ '@context': 'https://schema.org', '@graph': [bc({ name: 'Home', item: `${S}/` }, { name: 'Why Choose Us', item: `${S}/why-us/` }), { '@type': 'FAQPage', mainEntity: [{ '@type': 'Question', name: 'Why should I choose COSS Cloud Solutions for IT training?', acceptedAnswer: { '@type': 'Answer', text: 'COSS Cloud Solutions offers industry expert trainers with 10+ years experience, 100% placement assistance, small batch sizes, flexible scheduling, globally recognised certifications and affordable fees.' } }, { '@type': 'Question', name: 'Does COSS provide 100% placement support?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, COSS provides 100% placement assistance including resume building, mock interviews, company referrals and interview coaching. Over 5000 students have been placed.' } }, { '@type': 'Question', name: 'Does COSS offer online training?', acceptedAnswer: { '@type': 'Answer', text: 'Yes, COSS offers live interactive online training alongside offline batches at Dilsukhnagar and Ameerpet. All sessions are recorded for review.' } }, { '@type': 'Question', name: 'What certifications does COSS prepare students for?', acceptedAnswer: { '@type': 'Answer', text: 'AWS, Microsoft Azure, Google Cloud, CompTIA, CEH, Salesforce, SAP and many more globally recognised IT certifications.' } }] }] }),
  },
  {
    pageSlug: 'contact',
  ...
  },
  {
    ...
    metaTitle: '100% Placement Assistance — IT Training Hyderabad | COSS',
    ...
    ogDescription: '5000+ students placed in top IT companies. Resume building, mock interviews, campus drives & company referrals. Start your IT career with full support at COSS.',
    ogImage: OG_IMAGE,
  ...
  },
  {
    ...
    metaTitle: 'IT Certifications in Hyderabad — AWS, Azure, Google | COSS',
    ...
    ogTitle: 'IT Certifications — AWS, Azure, Google & More | COSS',
  ...
  },
  {
    ...
    keywords: 'enroll IT course Hyderabad, IT training admission Hyderabad, join IT course Hyderabad, COSS enrollment, start IT training Hyderabad',
    ogTitle: 'Enroll in IT Training — COSS Cloud Solutions Hyderabad',
    ogDescription: 'Start your IT career today. Join 30+ expert-led courses in AI, Cloud, DevOps & Data Science. Free demo available. 100% placement assistance at COSS.',
    ogImage: OG_IMAGE,
  ...
  },
  {
    ...
    keywords: 'free demo class Hyderabad, IT training demo Hyderabad, free IT class, COSS free demo, IT training trial Hyderabad',
  ...
  },
  {
    ...
    keywords: 'COSS terms conditions, IT training enrollment policy, refund policy Hyderabad, student conduct guidelines COSS',
...
export async function seedBlogPosts(): Promise<void> {
  ...
  for (const file of files) {
    try {
      ...
      const metaTitle = truncate(title, 55) + ' | COSS';
