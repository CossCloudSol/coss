...
const DEFAULTS: HomepageSettings = {
  ...
  heroSubtext: 'Hands-on training at Dilsukhnagar & Ameerpet. Real projects, certified trainers, 100% placement support.',
  ...
  stat1Value: '15+', stat1Label: 'Years Experience',
  stat2Value: '5000+', stat2Label: 'Students Placed',
  stat3Value: '30+', stat3Label: 'Courses',
  stat4Value: '200+', stat4Label: 'Hiring Partners',
