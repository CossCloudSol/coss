        ...
        <div className={sectionCls}>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2">
              ...
              <input required value={form.title} onChange={(e) => handleField('title', e.target.value)} className={inputCls} placeholder="e.g. Getting Started with AWS" />
            </div>
            <div>
              <label className={labelCls}>Slug *</label>
              <input required value={form.slug} onChange={(e) => handleField('slug', e.target.value)} className={inputCls} placeholder="getting-started-with-aws" />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea required rows={2} value={form.excerpt} onChange={(e) => handleField('excerpt', e.target.value)} className={inputCls} placeholder="Short description shown in listings…" />
          </div>
        </div>
